<?php
	...
	$wfsUrl = file_get_contents("http://localhost:8081/geoserver/SLEMAN_COV19/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SLEMAN_COV19%3Ars_rujukan&outputFormat=application%2Fjson");
